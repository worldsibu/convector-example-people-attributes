...
hurl invoke person person_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
hurl install person node -P ./chaincode-person
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install person node -P ./chaincode-person --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade person node 1.2 -P ./chaincode-person
```
